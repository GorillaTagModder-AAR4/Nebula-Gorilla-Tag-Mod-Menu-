...
{
	public static string MenuTitle = "Nebula Client - V1.1.9";
	...
	public static List<ButtonInfo> CatButtons1 = new List<ButtonInfo>
	{
		...
		new ButtonInfo
		{
			buttonText = "Virtual Stump Kick Gun (M)",
			method = delegate
			{
				Mods.VirtualStumpKickGun();
			},
			enabled = false,
			toolTip = "Kicks whoever your hand desires in Virtual Stump!"
		},
		new ButtonInfo
		{
			buttonText = "Virtual Stump Kick All (M)",
			method = delegate
			{
				Mods.VirtualStumpKickAll();
			},
			enabled = false,
			nontoggleable = true,
			toolTip = "Kicks everyone in Virtual Stump!"
		}
	};
	...
	public static List<ButtonInfo> CatButtons4 = new List<ButtonInfo>
	{
		...
		new ButtonInfo
		{
			buttonText = "Grab Bug (LG) (RG)",
			method = delegate
			{
				Mods.GrabBug();
			},
			enabled = false,
			toolTip = "Puts the bug on your hand!"
		},
		new ButtonInfo
		{
			buttonText = "Grab Bat (LG) (RG)",
			method = delegate
			{
				Mods.GrabBat();
			},
			enabled = false,
			toolTip = "Puts the bat on your hand!"
		},
		new ButtonInfo
		{
			buttonText = "Grab Firefly (LG) (RG)",
			method = delegate
			{
				Mods.GrabFirefly();
			},
			enabled = false,
			toolTip = "Puts the firefly on your hand!"
		},
		new ButtonInfo
		{
			buttonText = "Mats Gun",
		...
		new ButtonInfo
		{
			...
			method = delegate
			{
				Mods.CreateLobby("<color=#8A2BE2>Nebula Client V1.1.9</color>", "\"Nebula Menu\"");
			},
			enabled = false,
			nontoggleable = true,
	...
	public static List<ButtonInfo> CatButtons8 = new List<ButtonInfo>
	{
		new ButtonInfo
		{
			buttonText = "backround mods that are needed to run",
			method = delegate
			{
				Mods.Cat8();
			},
	...
	public static string[] CustomBoardTexts = new string[4] { "Thanks For Using Nebula 1.1.9!", "My YT Channel", "My YT channel name is @Grayson_GT      Thanks for 42 subs!\nLETTER MEANINGS\nServer Sided (SS)\nClient Sided (CS)\nNot Working (NW)\nMaybe Working (MW)\nDetected (D)\nDetected Over Time (TD)\nLeft Grip (LG)\nRight Grip (RG)\nLeft Trigger (LT)\nRight Trigger (RT)", "Thanks for using build 1.1.9 of Nebula! This menu is made by @Grayson_GT. This menu is powered by Malachis Menu Temp. I am NOT responsible for any bans using this menu. Note: The detected mods (D) on the menu are extremeley bannable, but right now, there are no detected mods so you should be fine." };
