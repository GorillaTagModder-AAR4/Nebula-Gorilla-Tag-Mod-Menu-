...
{
	public static string MenuTitle = "Nebula Client - V1.2.1";
	...
	public static List<ButtonInfo> buttons = new List<ButtonInfo>
	{
		...
		new ButtonInfo
		{
			buttonText = "Sound Mods",
			method = delegate
			{
				Mods.Cat7();
			},
			enabled = false,
			toolTip = "Go To Sound Mods!"
		}
	};
	...
	public static List<ButtonInfo> CatButtons2 = new List<ButtonInfo>
	{
		...
		new ButtonInfo
		{
			...
			enabled = false,
			nontoggleable = true,
			toolTip = "Gives you extremely long arms!"
		},
		new ButtonInfo
		{
			buttonText = "Wall Walk (LG) (RG)",
			method = delegate
			{
				Mods.WallWalk();
			},
			enabled = false,
			toolTip = "Makes you able to walk on walls!"
		},
		new ButtonInfo
		{
			buttonText = "Up and Down (LT) (RT)",
			method = delegate
			{
				Mods.UpAndDown();
			},
			enabled = false,
			toolTip = "Makes you able to move up and down!"
		}
	};
	...
	public static List<ButtonInfo> CatButtons3 = new List<ButtonInfo>
	{
		...
		new ButtonInfo
		{
			buttonText = "Anti-Report <color=green>[Player]</color>",
			method = delegate
			{
				Mods.AntiReport();
			},
		...
		new ButtonInfo
		{
			buttonText = "Disconnect (RT)",
			method = delegate
			{
				Mods.DisconnectRT();
			},
			enabled = false,
			toolTip = "Disconnects you if you press your right trigger!"
		},
		new ButtonInfo
		{
			buttonText = "Disconnect (LT)",
			method = delegate
			{
				Mods.DisconnectLT();
			},
			enabled = false,
			toolTip = "Disconnects you if you press your left trigger!"
		},
		new ButtonInfo
		{
		...
		new ButtonInfo
		{
			buttonText = "Semi Anti-Ban",
			method = delegate
			{
				Mods.AntiBan();
			},
			enabled = false,
			toolTip = "Helps so you don't get banned easily!"
		}
	};
	...
	public static List<ButtonInfo> CatButtons4 = new List<ButtonInfo>
	{
		...
		new ButtonInfo
		{
			buttonText = "Invisible Monke (B)",
			method = delegate
			{
				Mods.Invisible();
			},
			enabled = false,
			toolTip = "Makes you invisible when holding B!"
		},
		new ButtonInfo
		{
		...
		new ButtonInfo
		{
			buttonText = "Random Strobe Self",
			method = delegate
			{
				Mods.RandomStrobe();
			},
			enabled = false,
			toolTip = "Makes you strobe random colors!"
		},
		new ButtonInfo
		{
			buttonText = "Rainbow Strobe Self",
			method = delegate
			{
				Mods.RainbowStrobe();
			},
		...
		new ButtonInfo
		{
			...
			enabled = false,
			nontoggleable = true,
			toolTip = "Makes you get a random color!"
		},
		new ButtonInfo
		{
			buttonText = "Owner's Color Self",
			method = delegate
			{
				Mods.Set279Color();
			},
			enabled = false,
			nontoggleable = true,
			toolTip = "Sets your color to the owner's color!"
		},
		new ButtonInfo
		{
		...
		new ButtonInfo
		{
			buttonText = "Ungrabbable Block Gun (M)",
			method = delegate
			{
				Mods.UngrabbableBlockGun();
			},
			enabled = false,
			toolTip = "Adds a ungrabbable block wherever your hand desires!"
		},
		new ButtonInfo
		{
		...
		new ButtonInfo
		{
			buttonText = "Destroy Blocks on Touch (M)",
			method = delegate
			{
				Mods.DestroyBlocksOnHandTouch();
			},
			enabled = false,
			toolTip = "Makes it so if you touch a block, it destroys it!"
		},
		new ButtonInfo
		{
			...
			method = delegate
			{
				Mods.CreateLobby("<color=#8A2BE2>Nebula Client V1.2.1</color>", "\"Nebula Menu\"");
			},
			enabled = false,
			nontoggleable = true,
		...
		new ButtonInfo
		{
			...
			enabled = false,
			nontoggleable = true,
			toolTip = "Changes the projectile you use for the projectile mods!"
		},
		new ButtonInfo
		{
			buttonText = "Get Projectile",
			method = delegate
			{
				Mods.SpawnProjInHand();
			},
			enabled = false,
			toolTip = "Spawns the selected projectile in your hand!"
		},
		new ButtonInfo
		{
			...
			enabled = false,
			toolTip = "Spawns the selected projectile wherever your hand desires!"
		},
		new ButtonInfo
		{
			buttonText = "Hoverboard Launcher",
			method = delegate
			{
				Mods.HoverboardShooter();
			},
			enabled = false,
			toolTip = "Shoots a hoverboard!"
		},
		new ButtonInfo
		{
			buttonText = "Info Gun",
			...
			enabled = false,
			toolTip = "Shows you info of whoever your hand desires!"
		},
		new ButtonInfo
		{
			buttonText = "Size Changer (CS) (LG) (RG) (A)",
			method = delegate
			{
				Mods.SizeChanger();
			},
			disableMethod = delegate
			{
				Mods.DisableSizeChanger();
			},
			enabled = false,
			toolTip = "Makes you able to change your size!"
		}
	};
	...
	public static List<ButtonInfo> CatButtons6 = new List<ButtonInfo>
	{
		...
		new ButtonInfo
		{
			...
			enabled = false,
			nontoggleable = true,
			toolTip = "Join The Official Menu Discord Server!"
		},
		new ButtonInfo
		{
			buttonText = "Get All Cosmetics (CS)",
			method = delegate
			{
			...
			enabled = false,
			nontoggleable = true,
			toolTip = "Gives you every cosmetic!"
		},
		new ButtonInfo
		{
		...
		new ButtonInfo
		{
			...
			enabled = false,
			toolTip = "Prevents tag freeze!"
		},
		new ButtonInfo
		{
			buttonText = "Ghost Trolling Mode",
			method = delegate
			{
				Mods.GhostMode();
			},
			enabled = false,
			nontoggleable = true,
			toolTip = "Enables ghost trolling mods!\nEnables:\nPlatforms (LG) (RG)\nNoClip (RT)\nInvisible Monke (B)"
		}
	};
	...
	public static List<ButtonInfo> CatButtons7 = new List<ButtonInfo>
	{
		...
		new ButtonInfo
		{
			buttonText = "Random Sound Spam (RG)",
			method = delegate
			{
				Mods.RandomSoundSpam();
			},
			enabled = false,
			toolTip = "Spams a random sound!"
		},
		new ButtonInfo
		{
			buttonText = "Crystal Sound Spam (RG)",
			method = delegate
			{
				Mods.CrystalSoundSpam();
			},
			enabled = false,
			toolTip = "Spams the crystal sound!"
		},
		new ButtonInfo
		{
			buttonText = "Siren Sound Spam (RG)",
			method = delegate
			{
				Mods.SirenSoundSpam();
			},
			enabled = false,
			toolTip = "Spams the siren sound!"
		},
		new ButtonInfo
		{
			buttonText = "Bass Sound Spam (RG)",
			method = delegate
			{
				Mods.BassSoundSpam();
			},
			enabled = false,
			toolTip = "Spams the bass sound!"
		},
		new ButtonInfo
		{
			buttonText = "Metal Sound Spam (RG)",
			method = delegate
			{
				Mods.MetalSoundSpam();
			},
			enabled = false,
			toolTip = "Spams the metal sound!"
		},
		new ButtonInfo
		{
			buttonText = "Wolf Sound Spam (RG)",
			method = delegate
			{
				Mods.WolfSoundSpam();
			},
			enabled = false,
			toolTip = "Spams the wolf sound!"
		},
		new ButtonInfo
		{
			buttonText = "Cat Sound Spam (RG)",
			method = delegate
			{
				Mods.CatSoundSpam();
			},
			enabled = false,
			toolTip = "Spams the cat sound!"
		},
		new ButtonInfo
		{
			buttonText = "Turkey Sound Spam (RG)",
			method = delegate
			{
				Mods.TurkeySoundSpam();
			},
			enabled = false,
			toolTip = "Spams the turkey sound!"
		},
		new ButtonInfo
		{
			buttonText = "Frog Sound Spam (RG)",
			method = delegate
			{
				Mods.FrogSoundSpam();
			},
			enabled = false,
			toolTip = "Spams the frog sound!"
		},
		new ButtonInfo
		{
			buttonText = "Bee Sound Spam (RG)",
			method = delegate
			{
				Mods.BeeSoundSpam();
			},
			enabled = false,
			toolTip = "Spams the bee sound!"
		},
		new ButtonInfo
		{
			buttonText = "Squeak Sound Spam (RG)",
			method = delegate
			{
				Mods.SqueakSoundSpam();
			},
			enabled = false,
			toolTip = "Spams the squeak sound!"
		},
		new ButtonInfo
		{
			buttonText = "Earrape Sound Spam (RG)",
			method = delegate
			{
				Mods.EarrapeSoundSpam();
			},
			enabled = false,
			toolTip = "Spams the earrape sound!"
		},
		new ButtonInfo
		{
			buttonText = "Ding Sound Spam (RG)",
			method = delegate
			{
				Mods.DingSoundSpam();
			},
			enabled = false,
			toolTip = "Spams the ding sound!"
		},
		new ButtonInfo
		{
			buttonText = "Big Crystal Sound Spam (RG)",
			method = delegate
			{
				Mods.BigCrystalSoundSpam();
			},
			enabled = false,
			toolTip = "Spams the big crystal sound!"
		},
		new ButtonInfo
		{
			buttonText = "Pan Sound Spam (RG)",
			method = delegate
			{
				Mods.PanSoundSpam();
			},
			enabled = false,
			toolTip = "Spams the pan sound!"
		},
		new ButtonInfo
		{
			buttonText = "AK47 Sound Spam (RG)",
			method = delegate
			{
				Mods.AK47SoundSpam();
			},
			enabled = false,
			toolTip = "Spams the AK47 sound!"
		},
		new ButtonInfo
		{
			buttonText = "Tick Sound Spam (RG)",
			method = delegate
			{
				Mods.TickSoundSpam();
			},
			enabled = false,
			toolTip = "Spams the tick sound!"
		},
		new ButtonInfo
		{
			buttonText = "Piano Sound Spam (RG)",
			method = delegate
			{
				Mods.PianoSoundSpam();
			},
			enabled = false,
			toolTip = "Spams the piano sound!"
		}
	};
	...
	public static List<ButtonInfo> CatButtons10 = new List<ButtonInfo>
	{
		...
		new ButtonInfo
		{
			buttonText = "NameTag 1",
			method = delegate
			{
				Mods.SpecialNametag();
			},
			enabled = true,
			toolTip = "custom nametag!"
		}
	};
	...
	public static string[] CustomBoardTexts = new string[4] { "Thanks For Using Nebula 1.2.1!", "My YT Channel", "My YT channel name is @Grayson_GT      Thanks for 43 subs!\nLETTER MEANINGS\nServer Sided (SS)\nClient Sided (CS)\nLeft Grip (LG)\nRight Grip (RG)\nLeft Trigger (LT)\nRight Trigger (RT)", "Thanks for using build 1.2.1 of Nebula! This menu is made by @Grayson_GT. This menu is powered by Malachis Menu Temp. I am NOT responsible for any bans using this menu. Note: The detected mods (D) on the menu are extremeley bannable, but right now, there are no detected mods so you should be fine." };
