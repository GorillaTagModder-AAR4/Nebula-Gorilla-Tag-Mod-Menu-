...
internal class Mods : MonoBehaviour
{
		...
		public static void RainbowFurGunU()
		{
			...
			MakeGun(Color.white, new Vector3(0.15f, 0.15f, 0.15f), 0.025f, (PrimitiveType)0, GTPlayer.Instance.RightHand.controllerTransform, liner: true, delegate
			{
				if (Time.time > colorTimer)
				{
					...
					Player playerNearPointer = GetPlayerNearPointer();
					if (playerNearPointer != null)
					{
						VRRig vRRigFromPlayer = RigShit.GetVRRigFromPlayer(playerNearPointer);
	...
	public static Player GetPlayerNearPointer()
	{
		...
		MakeGun(Color.black, new Vector3(0.15f, 0.15f, 0.15f), 0.025f, (PrimitiveType)0, GTPlayer.Instance.RightHand.controllerTransform, liner: true, delegate
		{
			...
			if (playerNearPointer != null)
			{
				...
				for (int i = 0; i < 3960; i++)
				{
					...
					val2.TargetActors = new int[1] { playerNearPointer.ActorNumber };
		...
		MakeGun(Color.red, new Vector3(0.15f, 0.15f, 0.15f), 0.025f, (PrimitiveType)0, GTPlayer.Instance.RightHand.controllerTransform, liner: true, delegate
		{
			...
			if (playerNearPointer != null)
			{
				for (int i = 0; i < 150; i++)
				{
					...
					val.TargetActors = new int[1] { playerNearPointer.ActorNumber };
			...
			if (playerNearPointer != null)
			{
				...
				if ((Object)(object)vRRigFromPlayer != (Object)null)
				{
					...
					foreach (PhotonView val in array)
					{
						for (int j = 0; j < 20; j++)
						{
							val.RPC("RPC_PlayHandTap", playerNearPointer, new object[3] { 67, true, 0.1f });
						}
					}
				}
			}
	...
	public static void UntagGun()
	{
		...
		MakeGun(CurrentGunColor, new Vector3(0.15f, 0.15f, 0.15f), 0.025f, (PrimitiveType)0, GTPlayer.Instance.RightHand.controllerTransform, liner: true, delegate
		{
			...
			{
				Player val = GetPlayerNearPointer();
	...
	public static void MatGun()
	{
		...
		MakeGun(CurrentGunColor, new Vector3(0.15f, 0.15f, 0.15f), 0.025f, (PrimitiveType)0, GTPlayer.Instance.RightHand.controllerTransform, liner: true, delegate
		{
			...
			if (playerNearPointer != null)
			{
				val = NetPlayer.Get(playerNearPointer);
			}
	...
	public static void Ghostmonke()
	{
		...
		if (right)
		{
			if (WristMenu.ybuttonDown && !lastHit)
			{
				...
				if (ghostMonke)
				{
					frozenPosition = ((Component)VRRig.LocalRig).transform.position;
					frozenRotation = ((Component)VRRig.LocalRig).transform.rotation;
				}
			}
		...
		Rigidbody component = ((Component)VRRig.LocalRig).GetComponent<Rigidbody>();
		if (ghostMonke)
		{
			if ((Object)(object)component != (Object)null)
			{
			...
			((Component)VRRig.LocalRig).transform.position = frozenPosition;
			((Component)VRRig.LocalRig).transform.rotation = frozenRotation;
		}
	...
	public static void Invis()
	{
		...
		if (invisMonke)
		{
			...
			((Component)VRRig.LocalRig).transform.position = new Vector3(0f, -100f, 0f);
		}
		else
		{
			if ((Object)(object)component != (Object)null)
			...
			((Component)VRRig.LocalRig).transform.position = ((Component)GTPlayer.Instance).transform.position;
		}
	}
		...
		MakeGun(Color.yellow, new Vector3(0.15f, 0.15f, 0.15f), 0.025f, (PrimitiveType)0, GTPlayer.Instance.RightHand.controllerTransform, liner: true, delegate
		{
			if (PhotonNetwork.IsMasterClient && !((Object)(object)((RaycastHit)(ref raycastHit)).collider == (Object)null))
			{
				...
				if ((Object)(object)val == (Object)null)
				{
					...
					if (playerNearPointer != null)
					{
						val = RigShit.GetVRRigFromPlayer(playerNearPointer);
					}
				}
				if ((Object)(object)val != (Object)null)
				{
