...
internal class RigShit : MonoBehaviour
{
	...
	{
		if ((Object)(object)((RaycastHit)(ref Mods.raycastHit)).collider == (Object)null)
		{
			return null;
		}
		VRRig componentInParent = ((Component)((RaycastHit)(ref Mods.raycastHit)).collider).GetComponentInParent<VRRig>();
		return ((Object)(object)componentInParent != (Object)null) ? GetPlayerFromVRRig(componentInParent) : null;
	}
